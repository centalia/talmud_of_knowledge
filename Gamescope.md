...
|         `-S`, `--scaler`         | Задает тип масштабирования: <br>`auto`: автоматический режим, <br>`interger`: целочисленоное масштабирование, <br>`fit`: изображение вписывается в экран с сохранением пропорций, <br>`flll`: изображение заполняет весь с сохранением пропорций, но часть изображения, <br>`stretch`: изображение растягивается под разрешение экрана, без сохранения пропорций. |
