...
|     `-S`, `--scaler`     | Задает тип апскейлера: <br>`auto`: автоматический режим, <br>`interger`: целочисленоное мастабирование, <br>`fit`: изображение вписывается в экран с сохранением пропорций, <br>`flll`: изображение заполняет весь с сохранением пропорций, но часть изображения, <br>`stretch`:  |
|     `-F`, `--filter`     |                                                                                                          задает фильтр для апскейлера(linear, nearest, fsr, nis, pixel)                                                                                                           |
|                          |                                                                                                                                                                                                                                                                                   |
