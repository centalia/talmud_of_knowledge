...
|           Параметр           |                                                                                                                                                                          Значение                                                                                                                                                                           |
| :--------------------------: | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: |
|    `-W`, `--output-width`    |                                                                                                                             задает ширину, которое будет использовать Gamescope. <br>Если не задано, то используется `-W 1280.`                                                                                                                             |
|   `-H`, `--output-height`    |                                                                                                                             задает высоту, которое будет использовать Gamescope. <br>Если не задано, то используется  `-W 720`                                                                                                                              |
|    `-w`, `--nested-width`    |                                                                                                                           задает ширину, которое будет использовать сама игра. <br>Если не задано, то используется значение `-W`                                                                                                                            |
|   `-h`, `--nested-height`    |                                                                                                                           задает высоту, которое будет использовать сама игра. <br>Если не задано, то используется значение `-H`                                                                                                                            |
|   `-r`, `--nested-refresh`   |                                                                                                                                                  задает лимит кадров, которое будет использовать сама игра                                                                                                                                                  |
|     `-m`, `--max-scale`      |                                                                                                                                                       задает максимальные коэффициент мастабирования                                                                                                                                                        |
|       `-S`, `--scaler`       | Задает тип апскейлера: <br>`auto`: автоматический режим, <br>`interger`: целочисленоное мастабирование, <br>`fit`: изображение вписывается в экран с сохранением пропорций, <br>`flll`: изображение заполняет весь с сохранением пропорций, но часть изображения, <br>`stretch`: изображение растягивается под разрешение экрана, без сохранения пропорций. |
|       `-F`, `--filter`       |                                                    задает фильтр для апскейлера: <br>`linear`: линейная фильтрация, <br>`nearest`: фильтрация по методу "ближенего соседа", <br>`fsr`: AMD FidelityFX Super Resolution 1.0, <br>`nis`: NVIDIA Image Scaling v.1.0.3, <br>`pixel`: пиксельная фильтрация                                                     |
